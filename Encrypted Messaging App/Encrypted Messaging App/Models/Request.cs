...
namespace Encrypted_Messaging_App
{
    ...
    public class AcceptedRequest
    {
        ...
        {
            User requestUser = await FirestoreService.UserFromId(requestUserID);
    ...
    {   private IManageFirestoreService FirestoreService = DependencyService.Resolve<IManageFirestoreService>();
        ...
        {   (bool success, string message) result = await FirestoreService.WriteObject(this, $"Requests/{SourceUser.Id}", ("CUSERID", targetUserID));
